...
/// <summary>
/// Integration tests for CLIP ViT-B/32 image embeddings using the vision-only ONNX model.
/// Requires models/clip/vision_model.onnx (exported from openai/clip-vit-base-patch32).
/// </summary>
public class EmbeddingIntegrationTests : IDisposable
{
    private const string ModelPath = "models/clip/vision_model.onnx";
    ...
    public async Task MEAIGenerator_GenerateAsync_ReturnsEmbeddings()
    {
        ...
        var generator = new OnnxImageEmbeddingGenerator(transformer, modelId: "clip-vit-base-patch32");
        ...
        Assert.Equal(512, results[0].Vector.Length);
    ...
    public void Transform_IDataView_ProducesEmbeddingColumn()
    {
        ...
        Assert.Equal(512, embeddingBuffer.Length);
